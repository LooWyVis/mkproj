...
## Description
`mkproj` est une commande permettant de créer rapidement un projet en C, C++, Python ou Web avec une structure de base. Il offre également une option pour initialiser un dépôt Git.
